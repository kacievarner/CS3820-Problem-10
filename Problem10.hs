...
pr1_1 = Zero --Case for zero term

pr1_2 :: Lte1 (S (S Z)) (S (S Z))
pr1_2 = Succ(Succ Zero) --Case for 2 encapsulated terms

pr1_3 :: Lte1 (S (S Z)) (S (S (S Z)))
pr1_3 = Succ(Succ Zero) --More encapsulation
...
pr2_1 :: Lte2 Z (S (S (S (S Z)))) --Encapsulated "step" terms following model definition
pr2_1 = Step Lt1( --S 1
            Step Lt1( --S 2
                Step Lt1( --S 3
                    Step Lt1 Done))) --S 4 and closure

pr2_2 :: Lte2 (S (S Z)) (S (S Z))
pr2_2 = Done --Shown above in description definition

pr2_3 :: Lte2 (S (S Z)) (S (S (S Z)))
pr2_3 = Step Lt1 Done --Also shown in above description
...
pr3_1a = Trans(Trans(Inst Lt1) --Transitive(Transitive) of instance 1, S 1
                (Trans(Inst Lt1) --Transitive instance 2, S 2
                (Trans(Inst Lt1) --Transitive instance 3, S 3
                (Trans(Inst Lt1) --Transitive instance 4, S 4
                Refl)))) --Reflexive
                Refl --Reflexive closure

pr3_1b :: Lte3 Z (S (S (S (S Z))))
pr3_1b = Trans( --Transitive 1
            Trans( --Transitive 2
                Trans(Inst Lt1) --Transitive 3, instance 1 
                    (Inst Lt1)) --Instance 2
                    (Inst Lt1)) --Instance 3
                    (Inst Lt1) --Instance 4, Translation on 3 terms

pr3_2 :: Lte3 (S (S Z)) (S (S Z))
pr3_2 = Trans --Transitive 1
            Refl --Reflexive 1
            Refl --Reflexive 2

pr3_3 :: Lte3 (S (S Z)) (S (S (S Z)))
pr3_3 = Trans --Transitive 1
            (Inst Lt1) --Instance 1
            Refl --Reflexive 1
